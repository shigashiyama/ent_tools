...
from ent_tools.util.data_statistics import get_stats_from_dict
from ent_tools_spacy.util import get_stats_from_docbin
from ent_tools_spacy.data_io import convert_dict_to_docbin
